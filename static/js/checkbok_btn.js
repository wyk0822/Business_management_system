$(function() {
	...
	$("[name=youhui]").blur(function(){
		...
		if(isNaN(value)){
			...
			var price = Number(priceStr.substring(1,priceStr.length));
			//获取合计o
            var zongji = $("#youhui-top").val();
			$("#youhui-after").html("<strong>&yen;"+zongji-value+"</strong>");
		}
